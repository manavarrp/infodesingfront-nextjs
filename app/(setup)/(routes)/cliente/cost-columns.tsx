...
export const cost: ColumnDef<SectionsClient>[] = [
  {
    accessorKey: "Linea",
    header: ({ column }) => {
      return (
...

  {
    ...
    cell: ({ row }) => {
      const amount = parseFloat(row.getValue("costo_residencial"));
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const amount = parseFloat(row.getValue("costo_comercial"));
      const formatted = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(amount);
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const amount = parseFloat(row.getValue("costo_industrial"));
      const formatted = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(amount);
