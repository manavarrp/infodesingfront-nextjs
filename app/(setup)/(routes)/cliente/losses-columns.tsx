...
export const losses: ColumnDef<SectionsClient>[] = [
  {
    accessorKey: "Linea",
    header: ({ column }) => {
      return (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const amount = parseFloat(row.getValue("perdidas_residencial"));
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const amount = parseFloat(row.getValue("perdidas_comercial"));
      const formatted = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(amount);
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const amount = parseFloat(row.getValue("perdidas_industrial"));
      const formatted = new Intl.NumberFormat("en-US", {
        style: "currency",
        currency: "USD",
      }).format(amount);
